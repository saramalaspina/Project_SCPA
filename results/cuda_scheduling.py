...
def plot_combined(type_filter, output_filename):
    ...
    palette = {
        ...
        "no_warp": "#c084fc",  # vibrant lilac (pastel violet/lavender)
    }
    ...
    for i, group in enumerate(groups):
        ...
        axs[i].set_title(f"{type_filter} CUDA Scheduling Comparison - {titles[i]}")
...
plot_combined('HLL', 'cuda/graphs/hll_scheduling.png')
plot_combined('CSR', 'cuda/graphs/csr_scheduling.png')
