...
def plot_bar_gflops_comparison(df_few, df_many, save_path):
    ...
    axes[0].set_title("OpenMP AvgGFlops Comparison (CSR vs HLL) - Matrices with Few Non-Zeros (< 1e6)")
    ...
    axes[1].set_title("OpenMP AvgGFlops Comparison (CSR vs HLL) - Matrices with Many Non-Zeros (≥ 1e6)")
