...
# Run Python scripts
scripts=("cuda_csr_hll_speedup.py" "cuda_csr_hll.py" "openmp_csr_hll_speedup.py" "openmp_csr_hll.py" "openmp_threads_speedup.py" "openmp_threads.py")  # Add your Python scripts here
